...
const skills: Skilltype[] = [
  {name: 'CSS', url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/62/CSS3_logo.svg/800px-CSS3_logo.svg.png', level: 'Avanzado'},
  ...
  {name: 'EXPRESS', url: 'https://www.svgrepo.com/show/353724/express.svg', level: 'Avanzado'},
  {name: 'NODEJS', url: 'https://www.svgrepo.com/show/303658/nodejs-1-logo.svg', level: 'Intermedio'},
  {name: 'POSTGRSQL', url: 'https://www.svgrepo.com/show/354200/postgresql.svg', level: 'Intermedio'},
  {name: 'SEQUELIZE', url: 'https://www.svgrepo.com/show/354333/sequelize.svg', level: 'Intermedio'}
]
